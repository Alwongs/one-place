...
export const motherScheduleDaysApi = createApi({
    reducerPath: "motherScheduleDaysApi",
    ...
    endpoints: (build) => ({
        ...
        addScheduleMonth: build.mutation({
            query: (body) => ({ url: `mother-schedule-add-month`, method: "POST", body }),
            invalidatesTags: [
                {type: "ScheduleMonth", id: "LIST"},
        ...
        updateScheduleDay: build.mutation({
            query: (body) => ({
                url: `mother-schedule-update-day/${body.id}`,
                method: "PUT",
                body
            }),
        ...
        deleteScheduleMonth: build.mutation({
            query: ({ year, month }) => ({
                url: `mother-schedule-delete-month/${year}/${month}`,
                method: "DELETE",
            }),
            invalidatesTags: [
                {type: "ScheduleMonth", id: "LIST"},
